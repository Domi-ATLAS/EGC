...
|--------------------|-------|---------|------|------|--------|--------------------|
| Pizarro López, Eduardo | 80    | 24      | 13993   | 10   | 09     | Permitir al usuario recibir una contraseña si tiene la configuración necesaria y restablecer su contraseña y cambiar su contraseña una vez iniciada la sesion. Se intento implementar el WI search querys el cual se avanzo hasta el punto de poder buscar por cadenas exactas en el buscador de datasets  |
| Garate Fuentes, Yesica | 55    | 44      | 1019   | 9   | 10     |  Permitir al usuario recibir una contraseña si tiene la configuración necesaria y restablecer su contraseña. Se intento implementar el WI search querys el cual se avanzo hasta el punto de poder buscar por cadenas exactas en el buscador de datasets  |
| Portillo Sánchez, Alonso | 85    | 17      | 1210   | 12   | 18     | Realizacion de FakeNodo, además de incluir la vista del perfil de usuario y el filtro avanzado en la bsuqueda de datasets |
...
| Espinosa Naranjo, Pablo  | 90    | 31      | 1187   | 8   | 11     | Realizacion de FakeNodo, ha incluido una serie de botones que permiten que cada dataset pueda ser valorado entre 1 a 5 estrellas modificando la base de datos para su incorporación  |
